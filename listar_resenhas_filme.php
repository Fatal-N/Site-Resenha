...
<head>
    ...
    <link rel="stylesheet" href="css/estilo_filmes.css">
...
<body class="filmefundo">
    ...
    <h1 id="nominho">Essa página é dedicada às avaliações dos usuários referente aos filmes. Sinta-se a vontade para criar uma resenha!</h1>
    <div class="resenha-container">
        <?php
        $sql_resenhas = "SELECT rf.*, u.usu_login, f.titulo, f.imagem 
                         FROM tb_resenhas_filmes rf
                         JOIN tb_usuarios u ON rf.usuario_id = u.id
        ...
        while ($resenha = mysqli_fetch_assoc($result_resenhas)) {
            ...
            if (isset($_SESSION['usuario_id']) && $_SESSION['usuario_id'] == $resenha['usuario_id']) {
                ...
                echo "<a href='editar_resenha_filme.php?resenha_id={$resenha['id']}' title='Editar Resenha'>";
