...
$stmt = $link->prepare("SELECT rl.*, l.titulo, l.imagem 
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if ($stmt->execute()) {
        header("Location: listar_resenhas_livro.php?msg=Resenha atualizada com sucesso.");
        exit();
    } else {
  ...
  <div class="redesocial">
    ...
    <div class="container-glob">
        <form class="formulario1" method="post" action="">
            ...
            <div class="livr-card">
                <img class="livr-image" src="uploads/<?php echo htmlspecialchars($resenha['imagem']); ?>" alt="<?php echo htmlspecialchars($resenha['titulo']); ?>" style="width:200px; height:auto;">
            </div>
            ...
            <a href="listar_resenhas_livro.php" class="botao-voltar">Cancelar</a>
        </form>
