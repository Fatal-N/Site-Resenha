...
<div class="containermenu" width="1054px">
    ...
    <div class="container-glob">
        ...
        <h2 id="nominho2"><?php echo $livro['titulo']; ?></h2>
        <br>
        <div class="livr-card">
            <img class="livr-image" src="uploads/<?php echo $livro['imagem']; ?>" alt="<?php echo $livro['titulo']; ?>" style="width:200px; height:auto;">
        </div>
